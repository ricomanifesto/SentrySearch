...
export const SAMPLE_REPORT: ReportDetail = {
  ...
  evidence_admissibility: {
    ...
    blocking_findings: [],
    summary: {
      operationalSources: 3,
      contextSources: 0,
      excludedSources: 0,
      admittedIndicators: 0,
      contextIndicators: 0,
      rejectedIndicators: 0,
      coveredOperationalClaims: 4,
    },
  },
  claim_attributions: [
    {
  ...
  threat_data: {
    ...
    claimAttribution: {
      schemaVersion: '4',
      claims: [
        { claimClass: 'threat_activity', claimField: 'riskFactors', claimIndex: 0, evidenceRole: 'direct_evidence', claim: 'documents threat actors using Cobalt Strike Beacons for persistence, credential access, lateral movement, and data exfiltration in a wider intrusion chain.', sourceIds: ['S3'] },
        { claimClass: 'forensic_artifact', claimField: 'memoryArtifacts', claimIndex: 0, evidenceRole: 'direct_evidence', claim: 'A memory-resident Beacon payload inside an injected process is a forensic artifact analysts can preserve and investigate.', sourceIds: ['S2'] },
        { claimClass: 'detection_indicator', claimField: 'behavioralIndicators', claimIndex: 0, evidenceRole: 'direct_evidence', claim: 'Hunt for periodic callbacks to low-reputation infrastructure, accounting for sleep and jitter.', sourceIds: ['S1', 'S2'] },
        { claimClass: 'mitigation_action', claimField: 'preventiveMeasures', claimIndex: 0, evidenceRole: 'direct_evidence', claim: 'Enforce least privilege and application control to limit payload execution and lateral movement.', sourceIds: ['S2', 'S3'] },
      ],
    },
