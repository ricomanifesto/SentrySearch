    ...
    return {
        ...
        "claimAttribution": {
            ...
            "claims": [
                ...
                {
                    "claimClass": "forensic_artifact",
                    "claim": "HTTPS callbacks",
                    "claimField": "networkArtifacts",
                    "claimIndex": 0,
                    "evidenceRole": "direct_evidence",
                    "sourceIds": ["S1"],
                },
                ...
                },
                {
                    ...
                    "claim": "Application control",
                    "claimField": "preventiveMeasures",
                    "claimIndex": 0,
                ...
                {
                    "claimClass": "mitigation_action",
                    "claim": "Monitor service creation",
                    "claimField": "detectionMethods",
                    "claimIndex": 0,
                    "evidenceRole": "direct_evidence",
                    "sourceIds": ["S1"],
                },
                ...
                {
                    "claimClass": "mitigation_action",
                    "claim": "Rebuild compromised systems",
                    "claimField": "recoveryGuidance",
                    "claimIndex": 0,
                    "evidenceRole": "general_practice",
                    "sourceIds": [],
                },
